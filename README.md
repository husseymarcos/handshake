...
Write once. Apply everywhere. Perfect resumes in one click.
...
- **Background:** #FDFCF8 (A warm, paper-like off-white)
- **Text:** Stark, high-contrast Black (#000000)
- **Accent:** Trustworthy Blue (#2563EB) for primary actions

**Typography:**

- **Headings:** Sans-serif, extremely bold (font-black), and tightly tracked (tracking-tight)
- **Body & Descriptions:** Readable, elegant serif fonts to emphasize the document-centric nature of the app

**UI Elements:**

- Massive input fields with no visible borders until focused
- Pill-shaped navigation buttons
- Playful, hand-drawn aesthetic touches

## Tech Stack

- **Framework:** Ruby on Rails (Hotwire, Turbo, Stimulus)
- **Styling:** Native CSS with modern features (no Tailwind)
- **Database:** SQLite
- **AI Engine:** Google Gemini API (gemini-2.5-flash-preview) via RubyLLM
...
1. **Sign Up/In:** Create an account to securely store your profile.

2. **Build your Profile:** Navigate to "The Library" and add your skills and projects. Paste your base Typst template into the "Blueprint Template" tab.

3. **Adapt:** Go to "Apply", type the company name, paste the job description, and hit adapt.

4. **Download:** Once Handshake is done brewing your pitch, click the download button to grab your perfectly typeset PDF.
